                ...
                if($d['reqStatus'] == 'pending') {
                    ...
                    <div class='user_element black'>
                        ...
                        <div class='info'>
                            ...
                            <a href='/OSS//view/user_page.php?id=". $d['personID'] ."'>
            ...
            <div class='selector_box'>
                <div class='prof_type_selector'>
                    ...
                    <select name='prof_selector' onchange='this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);'>
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=all'>Stuff Role</option>
                        <!-- <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=all'>All Users</option>
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=phd'>Phd Student</option> -->
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=fix' >Fix-Term Researcher</option>
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=visitor'>Visitors</option>
                        <!-- <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=pro'>Professional staff</option>
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=ktp'>KTP Memeber</option> -->
                    </select>
                </div>
                ...
                <p>Filter by Start Date</p>
                    <select name='prof_selector' onchange='this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);'>
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=all'>Select Time Range</option>
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=startDate_1month' >Start in 1 month</option>
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=startDate_3month'>Start in 3 month</option>
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=startDate_6month'>Start in 6 month</option>
                    </select>
                </div>
                ...
                <p>Filter by End Date</p>
                    <select name='prof_selector' onchange='this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);'>
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=all'>Select Time Range</option>
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=endDate_1month' >Finish in 1 month</option>
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=endDate_3month'>Finish in 3 month</option>
                        <option value='https://csee.essex.ac.uk/OSS/view/user_directory.php?filter=endtDate_6month'>Finish in 6 month</option>
                    </select>
                </div>
        </div>
