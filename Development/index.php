...
<header>
        ...
        if ($_SESSION['Login'] == true) {
            echo '<a href="http://localhost/view/submit_request_prof.php" class="link">
        ...
        if ($_SESSION['Login'] == true) {
          if ($_SESSION['groupStatus'] == "ces-tech-g") {
            echo '<a href="http://localhost/view/user_directory.php" class="link">
        ...
        if ($_SESSION['Login'] == true) {
          if ($_SESSION['groupStatus'] == "ces-tech-g") {
            echo '<a href="http://localhost/view/requests_table.php" class="link">
        ...
        if ($_SESSION['Login'] == true) {
            echo '<a href="http://localhost/index.php" class="link">
        ...
        <section class="login_menu">
          ...
          if(isset($_POST['ok'])){
            if ($_POST['username'] == '' or $_POST['password'] == '') {
              ...
              $ldapconn = ldapLogin($_POST['username'], $_POST['password'], "http://localhost/view/requests_table.php");
