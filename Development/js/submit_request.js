...
btn.onclick = (event) => {
    ...
    if (value == "Visitors") {
        document.location.href = 'http://localhost/view/submit_request_visitor.php';
    }
    else if (value == "phd") {
        document.location.href = 'http://localhost/view/submit_request_phd.php';
    }
    else if (value == "fix") {
        document.location.href = 'http://localhost/view/submit_request_acad.php';
    }
    else if (value == "pro") {
        document.location.href = 'http://localhost/view/submit_request_prof.php';
    }
    else if (value == "ktp") {
        document.location.href = 'http://localhost/view/submit_request_ktp.php';
    }
};
